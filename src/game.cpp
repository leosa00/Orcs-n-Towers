...
Game::Game() : window_(sf::VideoMode(1000, 800), "Orcs n Towers") {
    ...
    tower_textures_.load(Textures::MissileTower, "/home/ottolitkey/cpp/tower-defense-tran-duong-2/textures/pausebutton.png");//pause button texture needs to be changed to its own texture class later
