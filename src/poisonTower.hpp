 ...
 * 
 * The Poison Tower is a specialized tower that applies the poison effect on all the enemies within its range. 
...
public:
     ...
     * 
     * @param position The initial position of the PoisonTower.
    */
...
private:
    /**
     * @brief List of enemies currently locked by the Poison Tower.
     * 
